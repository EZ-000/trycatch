...
public class SimpleUserInfo {
    ...
    public static SimpleUserInfo from(User user) {
        ...
        return SimpleUserInfo.builder().userId(user.getId()).userName(user.getUsername()).profileImage(user.getImageSrc()).companyName(user.getCompany().getName()).isFollowed(false).build();
    }
}
