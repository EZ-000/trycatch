...
public class SimpleUserDto implements Serializable {
    ...
    private SimpleUserDto(Long userId, String userName, String profileImage, String companyName, Boolean isFollowed) {
        this.userId = userId;
    ...
    private static SimpleUserDto from(User author, User requestUser) {
        ...
        return new SimpleUserDto(author.getId(), author.getUsername(), author.getImageSrc(), companyName, followees.contains(followees.contains(author)) // FIXME
        );
    }
    ...
    private static SimpleUserDto from(User author) {
        final Company company = author.getCompany();
        final String companyName = null == company ?"" : company.getName();
        return new SimpleUserDto(author.getId(), author.getUsername(), author.getImageSrc(), companyName, false);
    }
