...
public class SearchQuestionResponseDto {
    ...
    @Builder
    public SearchQuestionResponseDto(QuestionCategory categoryName, String authorUsername, String title, String content, Long timestamp, Instant updatedAt, Integer viewCount, Integer likes, Boolean hidden, Set<Long> answerIds) {
